...
module GMO
  module Const
    ...
    API_ERROR_MESSAGES_EN = {
      ...
      'AP2000001' => "Payment error The Amazon checkout session ID is invalid.(Amazon Reason code: ResourceNotFound)",
      'AP2000002' => "Payment error It is an illegal operation for the state of Amazon.(Amazon Reason code: InvalidCheckoutSessionStatus)",
      'AP2000003' => "Payment error You have exceeded the maximum billing amount for your transaction.Please check if the amount change is valid and if the maximum amount has not been exceeded.See Amazon Pay V2 Payment Overview for details.(Amazon Reason code: TransactionAmountExceeded)",
      'AP2000004' => "Payment error Payment failed because the buyer canceled the transaction or refused to pay.(Amazon Reason code: CheckoutSessionCanceled)",
      'AP2000005' => "Payment error Payment failed. Please select another card.(Amazon Reason code: HardDeclined)",
      'AP2000006' => "Payment error Payment failed. Please select another card.(Amazon Reason code: PaymentMethodNotAllowed)",
      'AP2000007' => "Payment error The payment was rejected.(Amazon Reason code: AmazonRejected)",
      'AP2000008' => "Payment error A timeout occurred during the payment process on Amazon.(Amazon Reason code: TransactionTimedOut)",
      'AP2000009' => "Payment error Your Amazon account has been suspended or has not been registered.(Amazon Reason code: InvalidAccountStatus)",
      'AP2000010' => "Payment error A timeout occurred when making a request to Amazon.(Amazon Reason code: RequestTimeout)",
      'AP2000011' => "Payment error The number of requests to Amazon has exceeded the limit.(Amazon Reason code: TooManyRequests)",
      'AP2000012' => "Payment error The maximum number of refunds has been exceeded.(Amazon Reason code: TransactionCountExceeded)",
      'AP2000013' => "Payment error It is an illegal operation for the state of Amazon.(Amazon Reason code: InvalidChargePermissionStatus)",
      'AP2000014' => "Payment error It is an illegal operation for the state of Amazon.The Sales capture deadline may have been exceeded, or it may have been considered fraudulent and canceled by Amazon.(Amazon Reason code: InvalidChargeStatus)",
      'AP2000015' => "Payment error Payment failed. Please select another card.(Amazon Reason code: SoftDeclined)",
      'AP2000016' => "Payment error The Amazon Buyer Token is invalid.(Amazon Reason code: InvalidBuyerToken)",
      'AP2000017' => "Payment error The address information could not be obtained from Amazon.There may be a problem with the specified ID, or the address information may not be selected.",
      'AP2000097' => "Payment error An error has occurred on Amazon.(Amazon Reason code: ProcessingFailure)",
      'AP2000098' => "Payment error An error has occurred on Amazon.(Amazon Reason code: InternalServerError)",
      'AP2000099' => "Payment error It could not be processed because Amazon was overloaded or under maintenance.(Amazon Reason code: ServiceUnavailable)",
      'AP2000999' => "Payment error An unknown error has occurred on Amazon.",
      ...
      'B01009501' => '(501) HTTP-Status-NotImplemented',
      ...
      'E00000001' => 'Connection method error This is an error equivalent to HTTP status code 405.The HTTP method is not POST.',
      'E00000002' => 'Connection method error This is an error equivalent to HTTP status code 406.The Accept related item in the HTTP request header is incorrect.',
      'E00000003' => 'Connection method error This is an error equivalent to HTTP status code 415.The Content-type field in the HTTP request header is incorrect.',
      'E00000010' => 'Connection method error The HTTP content is empty or the format is incorrect.',
      ...
      'E61010003' => 'Merchant setting error Please cancel the payment and check the setting status by inquiring.',
      'E61020001' => 'Merchant setting error The specified payment method has been suspended.',
      'E61030001' => 'Merchant setting error Contract details error / Cannot be used with the current contract.Please cancel the payment and check the setting status by inquiring.',
      ...
      'E61544002' => 'Merchant setting error The Amazon Pay interlocking information settings are incorrect.Please cancel the payment and check the Amazon Pay setting status by inquiry.',
      'E82010001' => 'Execution exclusive error You can ignore this error. It was run from the same site at the same time.It will be executed normally with the starting lineup.',
      'E90010001' => 'Double transmission error (communication) Please check the status on the management screen. Later requests may not be notified properly.',
      'E91019999' => 'System error (database) Please indicate the transaction failure to the purchaser, confirm the situation by inquiry, and then cancel the transaction in some cases.',
      ...
      'E91099996' => 'System error (communication) Internal system error.Please contact us after confirming the occurrence time and calling parameters.',
      'E91099997' => 'System error (communication) The requested API does not exist. Please check the URL.',
      'E91099999' => 'Settlement process failed - please try again',
      'E92000001' => 'Flow limit over error The number of simultaneous processes exceeds the specified value.',
      'E92000002' => 'Flow limit over error The number of simultaneous processes exceeds the specified value.',
      ...
      'M01001005' => 'Input parameter error The number of characters in the version exceeds the maximum number of characters.',
      'M01002001' => 'Input parameter error The shop ID is not specified.',
      'M01002002' => 'Input parameter error The shop ID is not specified.',
      'M01002008' => 'Input parameter error The format of the shop ID is incorrect.',
      'M01003001' => 'Input parameter error No shop password has been specified.',
      'M01003008' => 'Input parameter error The shop password format is incorrect.',
      'M01004001' => 'Input parameter error The order ID is not specified.',
      'M01004002' => 'Input parameter error The transaction with the specified order ID has not been created.',
      'M01004010' => 'Input parameter error The order ID already exists.',
      'M01004012' => 'Input parameter error The order ID exceeds the maximum number of characters.',
      'M01004013' => 'Input parameter error The order ID contains invalid characters.',
      'M01004014' => 'Input parameter error The transaction with the specified order ID has already requested settlement.',
      'M01005001' => 'Amount not specified',
      'M01005005' => 'Amount too long',
      'M01005006' => 'Amount contains non-numeric characters',
      'M01005011' => 'Input parameter error The usage amount is out of the valid range.',
      'M01006005' => 'Tax/Shipping exceeds maximum allowed',
      'M01006006' => 'Tax/Shipping contains non-numeric characters',
      'M01007001' => 'Input parameter error No transaction ID is specified.',
      'M01007008' => 'Input parameter error The transaction ID format is incorrect.',
      'M01008001' => 'Input parameter error No transaction password has been specified.',
      'M01008008' => 'Input parameter error The transaction password format is incorrect.',
      ...
      'M01039012' => 'Input parameter error Merchant free item 1 exceeds the maximum number of bytes.',
      'M01039013' => 'Input parameter error Merchant Free Item 1 contains invalid characters.',
      'M01040012' => 'Input parameter error Merchant free item 2 exceeds the maximum number of bytes.',
      'M01040013' => 'Input parameter error Illegal characters are included in Merchant Free Item 3.',
      'M01041012' => 'Input parameter error Merchant free item 3 exceeds the maximum number of bytes.',
      'M01041013' => 'Input parameter error Illegal characters are included in Merchant Free Item 3.',
      ...
      'M01051001' => 'Input parameter error No payment method is specified.',
      'M01051005' => 'Input parameter error The payment method has exceeded the maximum number of characters.',
      'M01051011' => 'Input parameter error The payment method is not in the valid range.',
      'M01053002' => 'Convenience Store specified can not be used',
      'M01054001' => 'Input parameter error No processing category is specified.',
      'M01054004' => 'Input parameter error It is not a processable operation for the current state of the transaction.',
      'M01054010' => 'Input parameter error The specified processing category is not defined.',
      'M01055010' => 'Input parameter error The total value of the transaction usage amount and tax shipping fee does not match the specified usage amount and tax shipping fee total value.',
      'M01056001' => 'Redirect URL not specified',
      'M01056012' => 'Redurect URL too long',
      'M01057010' => 'Transaction is too old for cancellation',
      'M01058002' => 'Input parameter error The specified transaction does not exist.',
      'M01058010' => 'Input parameter error The shop ID of the transaction does not match the specified shop ID.',
      'M01059001' => 'Input parameter error The payment result return URL is not specified.',
      'M01059005' => 'Return Destination URL too long',
      'M01059012' => 'Input parameter error The payment result return URL exceeds the maximum number of characters.',
      ...
      'M01081011' => 'Input parameter error The payment start deadline seconds are not in the valid range.',
      'M01081013' => 'Input parameter error The payment start deadline second contains characters that are not available.',
      ...
      'M01085001' => 'Input parameter error No cancellation amount has been specified.',
      'M01085005' => 'Input parameter error The cancellation amount exceeds the maximum number of digits.',
      'M01085006' => 'Input parameter error The cancellation amount contains non-numeric characters.',
      'M01085010' => 'Amount at time of authorization and cancellation amount do not match',
      'M01085011' => 'Input parameter error The cancellation amount is not in the valid range.',
      'M01086005' => 'Input parameter error Cancellation tax The shipping fee exceeds the maximum number of digits.',
      'M01086006' => 'Input parameter error Cancellation tax The shipping fee contains non-numeric characters.',
      'M01086011' => 'Input parameter error Cancellation tax The shipping fee is not in the valid range.',
      ...
      'M01544001' => 'Input parameter error Neither the Amazon Checkout Session ID nor the Amazon Charge Permission ID is specified.',
      'M01547001' => 'Input parameter error The Amazon checkout session ID is not specified.',
      'M01547012' => 'Input parameter error The Amazon checkout session ID exceeds the maximum number of bytes.',
      'M01548001' => 'Input parameter error No order ID, Amazon checkout session ID, or Amazon buyer token is specified.',
      'M01549001' => 'Input parameter error The Amazon Charge Permission ID is not specified.',
      'M01549002' => 'Input parameter error The specified Amazon Charge Permission ID is not registered.',
      'M01549004' => 'Input parameter error The specified Amazon Charge Permission ID has already expired.',
      'M01549012' => 'Input parameter error The Amazon Charge Permission ID exceeds the maximum number of bytes.',
      ...
      'M01707012' => 'Input parameter error The Amazon Buyer Token has exceeded the maximum number of bytes.',
      'M01730010' => 'Input parameter error The specified settlement frequency unit is not defined.',
      'M01731010' => 'Input parameter error The specified settlement frequency value is undefined.',
    ...
    API_ERROR_MESSAGES_JA = {
      ...
      'AP2000001' => '決済エラー AmazonチェックアウトセッションIDが無効です。（Amazon Reason code：ResourceNotFound）',
      'AP2000002' => '決済エラー Amazonの状態に対して不正な操作です。（Amazon Reason code：InvalidCheckoutSessionStatus）',
      'AP2000003' => '決済エラー 取引の最大請求額を超えています。金額変更が有効となっているか、上限金額を超えていないかをご確認ください。詳細は Amazon Pay V2決済概要 を参照ください。（Amazon Reason code：TransactionAmountExceeded）',
      'AP2000004' => '決済エラー 購入者が取引をキャンセルしたか支払いが拒否されたため決済に失敗しました。（Amazon Reason code：CheckoutSessionCanceled）',
      'AP2000005' => '決済エラー 決済に失敗しました。他のカードを選択してください。（Amazon Reason code：HardDeclined）',
      'AP2000006' => '決済エラー 決済に失敗しました。他のカードを選択してください。（Amazon Reason code：PaymentMethodNotAllowed）',
      'AP2000007' => '決済エラー 決済が拒否されました。（Amazon Reason code：AmazonRejected）',
      'AP2000008' => '決済エラー Amazonでの決済処理時にタイムアウトが発生しました。（Amazon Reason code：TransactionTimedOut）',
      'AP2000009' => '決済エラー Amazonアカウントが停止されているか登録完了していません。（Amazon Reason code：InvalidAccountStatus）',
      'AP2000010' => '決済エラー Amazonへのリクエスト時にタイムアウトが発生しました。（Amazon Reason code：RequestTimeout）',
      'AP2000011' => '決済エラー Amazonへのリクエスト数が制限値を超えています。（Amazon Reason code：TooManyRequests）',
      'AP2000012' => '決済エラー 返金回数の上限を超過しました。（Amazon Reason code：TransactionCountExceeded）',
      'AP2000013' => '決済エラー Amazonの状態に対して不正な操作です。（Amazon Reason code：InvalidChargePermissionStatus）',
      'AP2000014' => '決済エラー Amazonの状態に対して不正な操作です。実売上期限が超過しているか、不正とみなされAmazonにてキャンセルされた可能性があります。（Amazon Reason code：InvalidChargeStatus）',
      'AP2000015' => '決済エラー 決済に失敗しました。他のカードを選択してください。（Amazon Reason code：SoftDeclined）',
      'AP2000016' => '決済エラー Amazonバイヤートークンが無効です。（Amazon Reason code：InvalidBuyerToken）',
      'AP2000017' => '決済エラー Amazonから住所情報が取得できませんでした。指定のIDに問題があるか、住所情報が選択されていない可能性があります。',
      'AP2000097' => '決済エラー Amazonにてエラーが発生しました。（Amazon Reason code：ProcessingFailure）',
      'AP2000098' => '決済エラー Amazonにてエラーが発生しました。（Amazon Reason code：InternalServerError）',
      'AP2000099' => '決済エラー Amazonにて過負荷が発生、またはメンテナンス中のため処理できませんでした。（Amazon Reason code：ServiceUnavailable）',
      'AP2000999' => '決済エラー Amazonにて不明なエラーが発生しました。',
      ...
      'E00000001' => '接続方式エラー HTTPステータスコード405相当のエラーです。HTTPメソッドがPOSTではありません。',
      'E00000002' => '接続方式エラー HTTPステータスコード406相当のエラーです。HTTPリクエストヘッダのAccept関連項目が正しくありません。',
      'E00000003' => '接続方式エラー HTTPステータスコード415相当のエラーです。HTTPリクエストヘッダのContent-type項目が正しくありません。',
      'E00000010' => '接続方式エラー HTTPコンテンツが空、またはフォーマットが正しくありません。',
      ...
      'E61010003' => '加盟店設定エラー 決済を中止して、問い合わせにて設定状況を確認してください。',
      'E61020001' => '加盟店設定エラー 指定の決済方法は利用停止になっています。',
      'E61030001' => '加盟店設定エラー ご契約内容エラー/現在のご契約では、ご利用になれません。決済を中止して、問い合わせにて設定状況を確認してください。',
      'E61040001' => 'カード番号を入力することはできません。現在のご契約では、カード番号を指定した…ド番号をそのまま連携するのではなく、トークン対応を実施ください。こちらのFAQをご参照ください。',
      'E61544002' => '加盟店設定エラー Amazon Pay連動情報の設定が正しくありません。決済を中止して、問い合わせにてAmazon Pay設定状況を確認してください。',
      'E82010001' => '実行の排他エラー このエラーは無視しても構いません。同じサイトから同時に実行されました。先発の実行分で正常に実行されます。',
      'E90010001' => '2重送信エラー(通信) 管理画面にて状態をご確認ください。後発のリクエストが正常に通知されない場合があります。',
      'E91019999' => 'システムエラー(データベース) 購入者に取引失敗を表示し、問い合わせにて状況を確認後、場合によって取消を行ってください。',
      'E91020001' => 'システムエラー(通信) 通信タイムアウトが発生しました。購入者に取引失敗を表示し、問い合わせにて状況を確認してください。',
      'E91029998' => 'システムエラー(通信) 決済処理に失敗しました。購入者に取引失敗を表示し、問い合わせにて状況を確認してください。',
      'E91029999' => 'システムエラー(通信) 決済処理に失敗しました。購入者に取引失敗を表示し、問い合わせにて状況を確認後、場合によって取消を行ってください。',
      'E91050001' => '決済処理に失敗しました。',
      'E91060001' => 'システムエラー(モジュールタイプ) システムの内部エラーです。購入者に取引失敗を表示し、発生時刻や呼び出しパラメータをご確認のうえ、お問い合わせください。',
      'E91099996' => 'システムエラー(通信) システムの内部エラーです。発生時刻や呼び出しパラメータをご確認のうえ、お問い合わせください。',
      'E91099997' => 'システムエラー(通信) リクエストされたAPIは存在しません。URLをお確かめください。',
      'E91099999' => 'システムエラー(想定外) 購入者に取引失敗を表示し、問い合わせにて状況を確認後、場合によって取消を行ってください。',
      'E92000001' => '流量制限オーバーエラー 同時処理数が規定値を超えています。',
      'E92000002' => '流量制限オーバーエラー 同時処理数が規定値を超えています。',
      ...
      'M01001005' => '入力パラメータエラー バージョンの文字数が最大文字数を超えています。',
      'M01002001' => '入力パラメータエラー ショップIDが指定されていません。',
      'M01002002' => '入力パラメータエラー 指定されたIDとパスワードのショップが存在しません。',
      'M01002008' => '入力パラメータエラー ショップIDの書式が正しくありません。',
      'M01003001' => '入力パラメータエラー ショップパスワードが指定されていません。',
      'M01003008' => '入力パラメータエラー ショップパスワードの書式が正しくありません。',
      'M01004001' => '入力パラメータエラー オーダーIDが指定されていません。',
      'M01004002' => '入力パラメータエラー 指定されたオーダーIDの取引は登録されていません。',
      'M01004010' => '入力パラメータエラー 既にオーダーIDが存在しています。',
      'M01004012' => '入力パラメータエラー オーダーIDが最大文字数を超えています。',
      'M01004013' => '入力パラメータエラー オーダーIDに不正な文字が含まれています。',
      'M01004014' => '入力パラメータエラー 指定されたオーダーIDの取引は既に決済を依頼しています。',
      'M01005001' => '利用金額が指定されていません。',
      'M01005005' => '利用金額が最大桁数を超えています。',
      'M01005006' => '利用金額に数字以外の文字が含まれています。',
      'M01005011' => '入力パラメータエラー 利用金額が有効な範囲を超えています。',
      'M01006005' => '税送料が最大桁数を超えています。',
      'M01006006' => '税送料に数字以外の文字が含まれています。',
      'M01007001' => '入力パラメータエラー 取引IDが指定されていません。',
      'M01007008' => '入力パラメータエラー 取引IDの書式が正しくありません',
      'M01008001' => '入力パラメータエラー 取引パスワードが指定されていません。',
      'M01008008' => '入力パラメータエラー 取引パスワードの書式が正しくありません。',
      ...
      'M01039012' => '入力パラメータエラー 加盟店自由項目1が最大バイト数を超えています。',
      'M01039013' => '入力パラメータエラー 加盟店自由項目1に不正な文字が含まれています。',
      'M01040012' => '入力パラメータエラー 加盟店自由項目2が最大バイト数を超えています。',
      'M01040013' => '入力パラメータエラー 加盟店自由項目2に不正な文字が含まれています。',
      'M01041012' => '入力パラメータエラー 加盟店自由項目3が最大バイト数を超えています。',
      'M01041013' => '入力パラメータエラー 加盟店自由項目3に不正な文字が含まれています。',
      ...
      'M01051001' => '入力パラメータエラー 決済方法が指定されていません。',
      'M01051005' => '入力パラメータエラー 決済方法が最大文字数を超えています。',
      'M01051011' => '入力パラメータエラー 決済方法が有効な範囲ではありません。',
      'M01053002' => '指定されたコンビニはご利用できません。',
      'M01054001' => '入力パラメータエラー 処理区分が指定されていません。',
      'M01054004' => '入力パラメータエラー 取引の現状態に対して、処理可能な操作ではありません。',
      'M01054010' => '入力パラメータエラー 指定された処理区分は定義されていません。',
      'M01055010' => '入力パラメータエラー 取引の利用金額・税送料の合計値が、指定された利用金額・税送料の合計値と一致しません。',
      'M01056001' => 'リダイレクトURLが指定されていません。',
      'M01056012' => 'リダイレクトURLが最大文字数を超えています。',
      'M01057010' => '取消可能な期間を超えています。',
      'M01058002' => '入力パラメータエラー 指定された取引が存在しません。',
      'M01058010' => '入力パラメータエラー 取引のショップIDが、指定されたショップIDと一致しません。',
      'M01059001' => '入力パラメータエラー 決済結果戻しURLが指定されていません。',
      'M01059005' => '戻り先URLが最大文字数を超えています。',
      'M01059012' => '入力パラメータエラー 決済結果戻しURLが最大文字数を超えています。',
      ...
      'M01731010' => '入力パラメータエラー 指定された決済頻度値は定義されていません。',
      ...
      'M01081011' => '入力パラメータエラー 支払開始期限秒が有効な範囲ではありません。',
      'M01081013' => '入力パラメータエラー 支払開始期限秒に利用できない文字が含まれています。',
      ...
      'M01085001' => '入力パラメータエラー キャンセル金額が指定されていません。',
      'M01085005' => '入力パラメータエラー キャンセル金額が最大桁数を超えています。',
      'M01085006' => '入力パラメータエラー キャンセル金額に数字以外の文字が含まれています。',
      'M01085010' => 'オーソリ時の金額とキャンセル金額が一致しません。',
      'M01085011' => 'キャンセル金額がオーソリ時の金額を超えています。',
      'M01086005' => '入力パラメータエラー キャンセル税送料が最大桁数を超えています。',
      'M01086006' => '入力パラメータエラー キャンセル税送料に数字以外の文字が含まれています。',
      'M01086011' => '入力パラメータエラー キャンセル税送料が有効な範囲ではありません。',
      ...
      'M01544001' => '入力パラメータエラー AmazonチェックアウトセッションID、AmazonチャージパーミッションIDがいずれも指定されていません。',
      'M01547001' => '入力パラメータエラー AmazonチェックアウトセッションIDが指定されていません。',
      'M01547012' => '入力パラメータエラー AmazonチェックアウトセッションIDが最大バイト数を超えています。',
      'M01548001' => '入力パラメータエラー オーダーID、AmazonチェックアウトセッションID、Amazonバイヤートークンがいずれも指定されていません。',
      'M01549001' => '入力パラメータエラー AmazonチャージパーミッションIDが指定されていません。',
      'M01549002' => '入力パラメータエラー 指定されたAmazonチャージパーミッションIDは登録されていません。',
      'M01549004' => '入力パラメータエラー 指定されたAmazonチャージパーミッションIDは既に終了しています。',
      'M01549012' => '入力パラメータエラー AmazonチャージパーミッションIDが最大バイト数を超えています。',
      ...
      'M01707012' => '入力パラメータエラー Amazonバイヤートークンが最大バイト数を超えています。',
      'M01730010' => '入力パラメータエラー 指定された決済頻度単位は定義されていません。',
